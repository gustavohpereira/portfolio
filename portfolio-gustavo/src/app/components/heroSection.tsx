...
export default function HeroSection(){
    return(
        <div className="h-screen flex flex-col justify-center text-center " id="home">
                ...
                <div className=" p-6  h-5/6 flex justify-center items-center gap-10 ">
                <Reveal>
                    <div className=" h-3/5 flex flex-col justify-center items-center">
                        <h1 className="text-6xl my-2">OLÁ, MEU NOME É GUSTAVO</h1>
                        <p className="text-4xl">Desenvolvedor de Software</p>

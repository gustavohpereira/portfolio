  ...
  return (
    ...
    >
      <div className=" p-6  h-5/6 flex flex-col lg:flex-row justify-center items-center gap-10 mt-14">
        ...
        <Reveal>
          <div className="h-3/5 flex flex-col justify-center items-center">
            <h1 className="text-5xl lg:text-6xl my-2">
            ...
            <div className="flex gap-6 my-6">
              ...
              <Link
                target="blank"
                href={"https://www.linkedin.com/in/gustavohpa/"}
              >
                <Image
                  src="linkedin.svg"
                  alt="linkedin logo"
      ...
      <div className="flex justify-center">
        <button
          className="rounded-full border-2 text-cyan-200  border-cyan-200 w-16 h-16 flex justify-center items-center  hover:bg-cyan-200 hover:text-black ease-in-out duration-1000"

const SliderData = [
    ...
    },
    {
      ...
      description: "Desenvolvido em parceria com uma professora o projeto API2, uma aplicação Java para organizar aulas, alunos, avaliações, notas e atividades. Este aplicativo opera totalmente offline, proporcionando flexibilidade e praticidade para a gestão acadêmica, mesmo em ambientes sem acesso à internet.",
